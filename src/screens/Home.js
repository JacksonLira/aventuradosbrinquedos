  ...
  return (
    <div className="App">
      ...
      >
        <img
          className="absolute   
                                    ...
                                    drop-shadow-[0_20px_20px_rgba(0,0,0,0.55)]"
          src={logo}
          alt=""
        />
        <h1
          className="absolute text-white
                                      ...
                                      font-GillMedium drop-shadow-[0_10px_10px_rgba(0,0,0,55)]"
        >
          APRESENTA:
        </h1>
        <img
      ...
      <div className="relative bg-cover bg-white-300 mobile:h-96 laptop:h-screen w-full overflow-hidden ">
        <h3 className="text-2xl mobile:text-sm mt-10 mobile:mt-5 tablet:text-lg laptop:text-2xl laptop:mb-10 font-GillHeavy">
          {' '}
        ...
        <Slider className="mx-2 mobile:mt-2" {...settings}>
          <div className="relative bg-yellow-300  mobile:h-72   max-w-xs  overflow-hidden rounded-2xl shadow-lg group border border-blue-900 hover:border-black border-4">
            <img
              className="laptop:w-96 transition-transform group-hover:scale-110 duration-200 inset-0 flex items-end bg-gradient-to-t from-black/60 to-transparent"
              src={woody}
              alt=""
            />
            <h3 className="absolute inset-0 flex laptop:items-center mobile:mt-20 tablet:text-2xl tablet:mt-32 laptop:mt-4 p-1 laptop:text-2xl font-bold mb-2 text-white ">
              Woody
            </h3>
            <p className="laptop:absolute tablet:absolute mobile:flex mobile:mt-5 tablet:mb-5 inset-0 flex laptop:items-end tablet:items-end tablet:text-lg  mobile:text-sm laptop:text-2xl text-blue-900 font-bold">
      ...
      <div className="relative mt-[-15px] mb-[-15px] bg-cover  bg-yellow-300 laptop:h-screen mobile:h-[540px] tablet:h-96 w-full border-full border-blue-900 border-t-4 rounded-t-[20px] border-b border-blue-900 border-b-4 rounded-b-[20px]">
        <div className="flex justify-center items-center mt-10">
          <div className="relative bg-red-500 mb-[400px]  mobile:w-30 skew-x-12 p-5 laptop:w-90 laptop:px-20">
            <h1 className="-skew-x-12 text-white mobile:text-sm laptop:text-2xl  laptop:font-bold laptop:text-left">
              CONHEÇA NOSSA HISTÓRIA
            </h1>
            <img
              className="absolute -skew-x-12 laptop:w-60 mobile:w-32 mobile:ml-[145px] mobile:mt-[-75px] laptop:ml-[275px] laptop:mt-[-114px] mt-[-108px]"
              src={wb}
              alt=""
            />
          </div>
          ...
          <p
            className="absolute mobile:text-sm tablet:text-md mobile:p-12 mobile:mt-20 laptop:mt-0 laptop:text-lg font-GillBold tablet:p-24 
      ...
      <div
        ...
        style={{ backgroundImage: `url(${Bgimg})` }}
      >
        <h1 className="absolute mt-10 laptop:left-[500px] mobile:left-[150px]  text-yellow-300 font-semibold mobile:text-sm laptop:text-4xl drop-shadow-[0_10px_10px_rgba(0,0,0,10)]">
          Duvidas?
        </h1>

        <a
          className="grid mb-10 ml-[450px] mobile:ml-20 grid-flow-col gap-x-2 items-end text-2xl text-white overflow-hidden"
          href="https://web.whatsapp.com/"
        >
          <FaWhatsapp size={72} color="red" />
          <span className="text-yellow-300 font-semibold text-2xl drop-shadow-[0_10px_10px_rgba(0,0,0,10)]">
            Fale Conosco !
          </span>
        </a>
      ...
      <div className="relative bg-cover mt-[-20px] bg-yellow-300 h-screen w-full border-t border-blue-900 border-t-4 rounded-t-[20px] border-b border-blue-900 border-b-4 rounded-b-[20px]">
        <div className="grid ml-96 mobile:mt-2 tablet:ml-32 mobile:ml-20 laptop:ml-96 laptop:mt-5 bg-red-500 skew-x-12 mobile:p-3 mobile:w-[265px] laptop:w-[500px] ">
          <h1 className="-skew-x-12 text-white mobile:text-sm mobile:text-left laptop:text-2xl laptop:ml-5   font-bold">
            COMPARTILHE NOSSOS VIDEOS{' '}
          </h1>
          <img
            className="absolute -skew-x-12 mobile:ml-[220px] mobile:w-[80px] mobile:mt-[-28px] laptop:w-32 laptop:ml-[400px] laptop:mt-[-57px]"
            src={Buzzy}
            alt=""
          />
        </div>
      ...
      <div
        className="mt-[-15px] bg-cover h-screen mobile:h-48 tablet:h-96 w-full "
        style={{ backgroundImage: `url(${Breserva})` }}
      >
        <img
          className="absolute mobile:w-12 mobile:py-5 tablet:w-24 tablet:py-10 flex 
                                      "
          src={logo}
          alt=""
        />
        ...
        <div className="flex justify-center items-center mt-[-10px]">
          <div className="relative mobile:mt-20 mobile:hidden laptop:block mobile:w-30 mobile:p-2 tablet:mt-10 bg-red-500 skew-x-12 tablet:p-3 laptop:p-5 w-80">
            <h1 className="-skew-x-12 text-white laptop:text-2xl  font-bold">
              Reserve já seu assento
            </h1>
            <img
              className="absolute -skew-x-12 laptop:w-[130px] laptop:mt-[-86px] mobile:w-[90px] mobile:mt-[-70px] tablet:w-[100px] tablet:mt-[-70px] ml-[250px] mt-[-108px] drop-shadow-[0_20px_20px_rgba(0,0,0,0.95)]"
              src={Jessy}
              alt=""
            />
          </div>
          <button
            type="button"
            className="absolute mobile:mt-48  laptop:mt-72 focus:outline-none text-white font-bold bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-7 py-2.5 me-2 mb-2"
          >
            Reserve seu assento
          </button>
        </div>
      ...
      <div
        className="bg-cover laptop:h-screen tablet:h-72 mobile:h-96 w-full"
        style={{ backgroundImage: `url(${ImgIgreja})` }}
      >
        <h1 className="text-yellow-300 font-semibold laptop:text-3xl mobile:text-lg tablet:text-xl drop-shadow-[0_10px_10px_rgba(0,0,0,10)]">
          COMO CHEGAR ?
        </h1>
        <div className="flex justify-center items-center mt-20 mobile:mt-5 tablet:mt-5">
          <iframe
            className="laptop:w-[900px] laptop:h-[400px] mobile:h-[200px] mobile:w-[340px] tablet:w-[600px] tablet:h-[150px] laptop:drop-shadow-[0_10px_10px_rgba(0,0,0,10)] mobile:overflow-hidden"
          ...
          <div className="absolute justify-center items-end laptop:mt-[500px] mobile:mt-[300px] tablet:mt-52">
            ...
            {showModal && (
              <Modal videoUrl={videoUrl} onClose={handleCloseModal} />
            )}
          </div>
        </div>
      </div>
      ...
      >
        ...
        <h1 className="absolute mobile:ml-32 mobile:mt-5 text-yellow-300 font-semibold laptop:text-3xl laptop:ml-[400px] mobile:text-lg tablet:text-xl drop-shadow-[0_10px_10px_rgba(0,0,0,10)]">
        ...
        <div className="grid laptop:mt-24 laptop:ml-10 laptop:space-x-3 laptop:p-8 mobile:space-y-2 mobile:mt-20  mobile:grid-cols-2 mobile:p-2 laptop:grid-cols-3 laptop:grid-rows-4 justify-center items-center mobile:overflow-hidden ">
          <div className="relative bg-red-500 laptop:ml-[3px] laptop:mt-[5px] skew-x-12 laptop:p-4 laptop:w-80 mobile:w-[150px] mobile:ml-5 tablet:w-52 drop-shadow-[0_10px_10px_rgba(0,0,0,9)]">
            <h1 className="absolute mt-[-40px] skew-y-6 -skew-x-12 text-7xl text-yellow-400 font-black border-font border-blue-80 hover:mt-[-50px]">
              19
            </h1>
            <Link
              to="/gallery"
      ...
      >
        <h1 className="absolute mb-96 laptop:mt-[-70px] text-yellow-300 p-3 font-semibold laptop:text-3xl tablet:xl drop-shadow-[0_10px_10px_rgba(0,0,0,10)]">
          CONHEÇA A NOSSA IGREJA!
        </h1>
        <iframe
          className="static laptop:mt-10 rounded-lg laptop:w-[700px] laptop:h-[400px] mobile:w-72 mobile:h-48"
          width="624"
          height="338"
      ...
      <div className="laptop:flex justify-center items-center bg-cover mobile:h-48 w-full bg-blue-200  tablet:h-32 ">
        <h1 className="text-black border-solid font-semibold laptop:place-items-center mobile:place-items-start mobile:text-sm ">
